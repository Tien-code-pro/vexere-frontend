				...
				<div className="footer_content">
					<div className="footer_top grid grid-cols-3 gap-6">
						<div className="footer_news">
							<div className="footer_title">Bến xe </div>
							<div className="footer_list">
								<a href="#">Bến xe Mỹ Đình</a>
								<a href="#">Bến xe Nước Ngầm</a>
								<a href="#">Bến xe Gia Lâm</a>
								<a href="#">Bến xe Giáp Bát</a>
								<a href="#">Bến xe khách Hà Giang</a>
							</div>
						</div>
						<div className="footer_stations">
							<div className="footer_title">Nhà xe</div>
							<div className="footer_list">
								<a href="#">Xe Sao Việt</a>
								<a href="#"> Xe Taxi Hoa Mai</a>
