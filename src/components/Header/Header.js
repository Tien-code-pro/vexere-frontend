		...
		<div className="header-container">
			<div className="header">
				<div className="grid grid-cols-8 d-flex items-center">
					<div className="header_right text-3xl" style={{height: "75px", width: "100%", marginLeft: "75px"}}>
						<div className="logo">
							<a
								onClick={() => {
									history.push("/");
							...
							>
								<img src="./images/logo1-3.png" alt={123} className="mb-5" style={{width: "60%"}} />
							</a>
						</div>
					</div>
					<div className="header_left col-span-6">
						<ul>
							<li>
								<a href="#xelimousine" target="_blank">
									Vé xe
								</a>
							</li>

							<li>
								<a href="#partner">Thuê xe</a>
							</li>
							<li>
								<a href="#station">Gửi hàng</a>
							</li>
							<li>
								<a href="#station">Quản lý đơn hàng</a>
							</li>
							<li>
								<a href="/Tintuc">Tin tức</a>
							</li>
							<li className="hotline">
								<Popover placement="bottom" title="Số Điện Thoại Tổng Đài" content={"0964952537"} trigger="click">
									<a href="#">
